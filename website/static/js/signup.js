...
let c_pass_inp = document.getElementsByName('confirm-password')[0];
...
signin_btn.addEventListener('click', e => {
    ...
    if(!(c_pass_inp.value)) {
        c_pass_inp.classList.remove('m_inp_border');
        c_pass_inp.classList.add('is-invalid');
    } else {
        c_pass_inp.classList.add('m_inp_border');
        c_pass_inp.classList.remove('is-invalid');
    }
})